...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const APIKEY = "65960ca168a96b233685676d";
  getContacts();
  ...
  document.getElementById("contact-submit").addEventListener("click", function (e) {
    ...
    fetch("https://fedp03-a695.restdb.io/rest/contact", settings)
  ...
  document.getElementById("contact-list").addEventListener("click", function (e) {
    ...
    if (e.target.classList.contains("delete")) {
      ...
      fetch(`https://fedp03-a695.restdb.io/rest/contact/${contactId}`, settings)
      .then(response => response.json())
      .then(data => {
        console.log(data);
        getContacts();
  ...
  function updateForm(id, contactName, contactEmail, contactMsg, contactMentor) {
    ...
    fetch(`https://fedp03-a695.restdb.io/rest/contact/${id}`, settings)
      .then(response => response.json())
      .then(data => {
        console.log(data);
        document.getElementById("update-contact-container").style.display = "none";
